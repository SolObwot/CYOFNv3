...
<html>
    ...
    <div class="wrapper">
      <div class="inner">
        <form method="POST" novalidate>
          ...
          <label class="container"
            >Very Likely
            <input type="radio" name="reply" value="Very Likely" />
            <span class="checkmark"></span>
          </label>

          <label class="container"
            >Likely
            <input type="radio" name="reply" value="Likely" />
            <span class="checkmark"></span>
          </label>

          <label class="container"
            >Meh!
            <input type="radio" name="reply" value="Meh!"/>
            <span class="checkmark"></span>
          </label>
          <label class="container"
            >Unlikely
            <input type="radio" name="reply" value="Unlikely" />
            <span class="checkmark"></span>
          </label>
          <br />
          ...
          <div id="backhome" style=" margin-left: 50px; 
  border: none;
  width: 162px;
  height: 51px;
  ...
  transition-duration: 0.3s;"><a href="index.html" style="color: #fff;
